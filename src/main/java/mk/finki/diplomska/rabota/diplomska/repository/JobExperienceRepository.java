...
public interface JobExperienceRepository extends JpaRepository<JobExperience,Long> {
    ...
    @Query("select s  from JobExperience s,StudentUser u where s.CompanyName like :companyName  and u.id = :id ")
    JobExperience findByNameStudent(String companyName,Long id);
